    ...
    <div id="my-cart">
        ...
        <form method="post" action="modules/cart/process-cart.php?action=submit">
            ...
            ?>
                <div class="cart-item row">
                    ...
                    <div class="cart-quantity col-lg-2 col-md-2 col-sm-12">
                        ...
                        <input type="number" id="quantity" class="form-control form-blue quantity" value="<?php echo $_SESSION['cart'][$cart_item['prd_id']]; ?>" name="quantity[<?php echo $cart_item['prd_id']; ?>]">
                    </div>
            ...
            <div class="row">
                ...
                <div class="cart-price col-lg-3 col-md-3 col-sm-12"><b><?php echo number_format($total_price, 0, ",", "."); ?></b></div>
            </div>
    </div>
<?php
} else {
    echo "<div class='alert alert-danger'>Có 0 sản phẩm trong giỏ hàng</div>";
}
?>
<!--	Cart	-->
...
<div id="customer">
    <div class="row">
        ...
        <div id="customer-name" class="col-lg-4 col-md-4 col-sm-12">
            <input placeholder="Họ và tên (bắt buộc)" type="text" name="user_name" class="form-control" id="user_name">
            <span id="user_name_error"></span>
        </div>
        <div id="customer-phone" class="col-lg-4 col-md-4 col-sm-12">
            <input placeholder="Số điện thoại (bắt buộc)" type="text" name="user_phone" class="form-control" id="user_phone">
            <span id="user_phone_error"></span>
        </div>
        <div id="customer-mail" class="col-lg-4 col-md-4 col-sm-12">
            <input placeholder="Email (bắt buộc)" type="text" name="user_email" class="form-control" id="user_email">
            <span id="user_email_error"></span>
        </div>
        <div id="customer-add" class="col-lg-12 col-md-12 col-sm-12">
            <input placeholder="Địa chỉ nhà riêng hoặc cơ quan (bắt buộc)" type="text" name="add" class="form-control" id="user_adress">
            <span id="user_adress_error"></span>
        </div>
    ...
    <div class="row">
        ...
        <div class="by-now col-lg-6 col-md-6 col-sm-12">
            <button class="btn btn-success" type="submit" name="" value="">
                <b>Trả góp Online</b>
                <span>Gọi ngay(+84) 96130 2360</span>
            </button>
        </div>
    </div>
    </form>
...
<script>
    function validateForm() {
        ...
        var user_adress_error = document.getElementById('user_adress_error');
        ...
        if (user_adress.value == EMPTY_STR) {
            user_adress.style.border = "1px solid red";
            user_adress_error.innerHTML = "Bạn phải nhập địa chỉ nhận";
            user_adress_error.style.color = "red";
            check = false;
        }
        return check;
    }
