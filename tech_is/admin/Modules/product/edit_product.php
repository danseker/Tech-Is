...
if (isset($_GET['prd_id'])) {
    ...
    if (isset($_POST['sbm'])) {
        if (empty($_POST['prd_name'])) {
            echo "ban chua nhap ten san pham";
        } else {
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li><a href="index.php?page=product">Quản lý sản phẩm</a></li>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="prd_status" class="form-control">
                                <option <?php if ($prodEdit['prd_new'] == 1) echo 'selected'; ?> selected value=1>Còn hàng</option>
                                <option <?php if ($prodEdit['prd_new'] == 2) echo 'selected'; ?> selected value=2>Hết hàng</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="checkbox">
                                <label>
                                    ...
                                    ?>
                                        <input checked name="prd_featured" type="checkbox" value=1>Nổi bật <?php } else { ?>
